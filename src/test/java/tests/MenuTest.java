...
public class MenuTest extends BaseTest {
    ...
    public void validate_Dashboard_Menu_Test() {
        DashboardPage dashboardPage = loginStep.successLogin(ReadProperties.getUsername(), ReadProperties.getPassword());
    ...
    public void validate_Projects_SideMenu_Test() {
        loginStep.successLogin(ReadProperties.getUsername(), ReadProperties.getPassword());
